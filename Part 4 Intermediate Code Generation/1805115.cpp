...
public:
    string asmVar;  //added for offline 4 for assembly variable names
    AdditionalInfo *ai;
    vector<string> asmArgs; //added for offline 4 for arguments
...
public:
    ...
    string giveCurrentScopeId()
    {
        return currentScopeTable->scopeId;
    }
